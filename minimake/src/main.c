...
#include "main.h"
static bool check_validity_target_main(struct makefile* make,struct target* targ_main){
...
static int get_list_Makefile_target(int argc,char* argv[],struct argument* arg){
